...
\begin{rem}\mbox{}
	...
	\item One can equivalently describe $\Rat(X)$ as the subgroup generated by the images of linearly trivial divisors on resolutions of singularities of subvarieties of $X$ \cite[Proposition 1.10]{eh16}\todo{better phrase this with rational functions}.
	\item In particular, linear and rational equivalence agree for divisors.
    \end{enumerate}
\end{rem}
