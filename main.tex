...
\thanks{Many thanks to Mara Ungureanu for her useful comments on a previous version of the programme!}
...
\section{Talk 1 --- Introduction and the Chow ring (16.12.20)}
...
\section{Talk 2 --- Basic computational tools (13.01.21)}
...
\section{Talk 3 --- Grassmannians and Schubert cycles (20.01.21)}
...
\section{Talk 4 --- How many lines intersect 4 random lines in space? (27.01.21)}
...
After this computation we can already answer \Cref{q1}.
...
\subsection{Geometry behind the answer to \Cref{q1}}
Paraphrasing \.{I}zzet Co\c{s}kun: What shape do you produce when you want to cook spaguetti and you put them in a pot?
What does the answer to this question have to do with \Cref{q1}?
See \cite[\S 3.4.1]{eh16}.

\section{Talk 5 --- Knutson--Tao puzzles and Chern classes (03.02.21)}
...
\section{Talk 6 --- How many lines does a smooth cubic surface contain? (10.02.21)}
...
The example relevant for \Cref{q2} is the dual of the tautological subbundle of rank $2$ on our Grassmannian $\bbG(1,3)$.
...
What does the argument in \cite[Thm.~5.1]{eh16} show and what remains to be shown in order to give a precise answer to \Cref{q2}?
